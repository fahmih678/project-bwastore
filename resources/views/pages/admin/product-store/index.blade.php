    ...
    <div class="section-content section-dashboard-home" data-aos="fade-up">
        <div class="container-fluid">
            ...
            <div class="dashboard-content">
                <div class="row">
                    <div class="col-12">
                        <a href="{{ route('product-store.create') }}" class="btn btn-success">Add New Product</a>
                    </div>
                </div>
                <div class="row mt-4">
                    <div class="col-12">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                                ...
                                <div class="row">
                                    @foreach ($products as $product)
                                        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                                            <a 
                                                href="{{ route('product-store.detail', $product->id) }}" 
                            ...
                            <div class="tab-pane fade" id="pills-buy" role="tabpanel" aria-labelledby="pills-buy-tab">
                                <!-- Content -->
                                @foreach ($products as $product)
                                    <a href="{{ route('product-store.detail', $product->id) }}" class="card card-list d-block">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-1">
